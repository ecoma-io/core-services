import { EventSourcingUnitOfWork } from './event-sourcing-unit-of-work';
import { DomainEvent } from '@ecoma-io/domain';

class InMemoryESUoW implements EventSourcingUnitOfWork {
