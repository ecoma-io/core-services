...
> extends IntrinsicException {
  ...
  constructor(
    ...
    private response?: ErrorResponse<TDetails, TMetaData>,
   ...
   * @returns {ErrorResponse<TDetails, TMetaData> | undefined} The error response object or undefined.
   */
  public getResponse(): ErrorResponse<TDetails, TMetaData> | undefined {
